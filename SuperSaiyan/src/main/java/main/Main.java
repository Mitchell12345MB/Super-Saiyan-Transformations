    ...
    if ((sender instanceof Player))
    {
      ...
      if ((cmd.getName().equalsIgnoreCase("Potential")) && (player.hasPermission("ssj.potential"))) {
        ...
        else if ((args[0].equalsIgnoreCase("unleashed")) && (player.hasPermission("ssj.potential")))
        {
          ...
          {
            player.sendMessage(this.Prefix + ChatColor.RED + "You must wait for " + this.cooldownTime.get(player) + 
              " seconds.");
            return true;
          }
          ...
          player.sendMessage(this.Prefix + ChatColor.GREEN + "You're now on a " + ChatColor.RED + this.Cooldown + 
            ChatColor.GREEN + " second cooldown!");
      ...
      if (cmd.getName().equalsIgnoreCase("ssj")) {
        ...
        else
        {
          ...
          {
            player.sendMessage(this.Prefix + ChatColor.RED + "You do not have permission to execute this command!");
          }
          else if (args[0].equalsIgnoreCase("list"))
          {
            ...
            if (player.hasPermission("ssj.x1"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Chance of failing this transformation: " + ChatColor.GOLD + 
                getConfig().getInt("Kaioken_x1.DamageOdds") + ChatColor.RED + " %");
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Kaioken_x1.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.x2"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Kaioken_x2.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.x3"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Kaioken_x3.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.x4"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Kaioken_x4.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.x20"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Kaioken_x20.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.x30"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Kaioken_x30.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.x40"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Kaioken_x40.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.x50"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Kaioken_x50.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.x100"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Kaioken_x100.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.superkaioken"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Super_Kaioken.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.ssbx10"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Chance of failing this transformation: " + ChatColor.GOLD + 
                getConfig().getInt("Kaioken_Super_Saiyan_Blue_1_x10.DamageOdds") + ChatColor.RED + 
                " %");
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
            ...
            if (player.hasPermission("ssj.potential"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Chance of failing this transformation: " + ChatColor.GOLD + 
                getConfig().getInt("Potential_Unleashed.DamageOdds") + ChatColor.RED + " %");
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Potential_Unleashed.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.false"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Chance of failing this transformation: " + ChatColor.GOLD + 
                getConfig().getInt("False_Super_Saiyan.DamageOdds") + ChatColor.RED + " %");
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("False_Super_Saiyan.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.1"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Super_Saiyan_1.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.ultimate"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Chance of failing this transformation: " + ChatColor.GOLD + 
                getConfig().getInt("Ultimate_Super_Saiyan.DamageOdds") + ChatColor.RED + " %");
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Ultimate_Super_Saiyan.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.legendary"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Chance of failing this transformation: " + ChatColor.GOLD + 
                getConfig().getInt("Legendary_Super_Saiyan_1.DamageOdds") + ChatColor.RED + " %");
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Legendary_Super_Saiyan_1.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.2"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Super_Saiyan_2.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.3"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Super_Saiyan_3.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.4"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Super_Saiyan_4.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.5"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Super_Saiyan_5.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.god"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Super_Saiyan_God.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
            if (player.hasPermission("ssj.ssb"))
            {
              ...
              player.sendMessage(ChatColor.RED + "Chance of failing this transformation: " + ChatColor.GOLD + 
                getConfig().getInt("Super_Saiyan_Blue_1.DamageOdds") + ChatColor.RED + " %");
              player.sendMessage(ChatColor.RED + "Damage taken if transformed incorrectly: " + ChatColor.GOLD + 
                getConfig().getInt("Super_Saiyan_Blue_1.DamageTaken"));
              player.sendMessage(ChatColor.RED + "----------------------------------------------");
            }
          }
          else if (args[0].equalsIgnoreCase("info"))
          {
            ...
            player.sendMessage(
              ChatColor.GREEN + "Plugin Developed by: " + ChatColor.RED + getDescription().getAuthors());
      ...
      if (cmd.getName().equalsIgnoreCase("kaioken")) {
        ...
        else
        {
          if ((args[0].equalsIgnoreCase("x1")) && (player.hasPermission("ssj.x1")))
          {
            ...
            player.performCommand("pp reddust");
            player.sendMessage(
              this.Prefix + ChatColor.RED + "The kaioken attack is vary limited in time, use it well!");
            player.sendMessage(this.Prefix + ChatColor.GREEN + "You're now on a " + ChatColor.RED + this.Cooldown + 
              ChatColor.GREEN + " second cooldown!");
            this.cooldownTime.put(player, Integer.valueOf(this.Cooldown));
            this.cooldownTask.put(player, new BukkitRunnable()
          ...
          if ((args[0].equalsIgnoreCase("super")) && (player.hasPermission("ssj.superkaioken")))
          {
            ...
            else if ((args[1].equalsIgnoreCase("kaioken")) && (player.hasPermission("ssj.superkaioken")))
            {
              if (this.cooldownTime.containsKey(player))
              {
            ...
            else if ((args[1].equalsIgnoreCase("x10")) && (player.hasPermission("ssj.ssbx10")))
            {
              ...
              if (getConfig().getBoolean("Kaioken_Super_Saiyan_Blue_1_x10.Use_Traits?.DAMAGE_RESISTANCE")) {
                player.addPotionEffect(new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 100000000, 
                  getConfig().getInt("Kaioken_Super_Saiyan_Blue_1_x10.Traits.DAMAGE_RESISTANCE")));
              }
              ...
              if (this.rand.nextInt(100) <= getConfig().getInt("Kaioken_Super_Saiyan_Blue_1_x10.DamageOdds"))
              {
                ...
                if (getConfig().getBoolean("Kaioken_Super_Saiyan_Blue_1_x10.Use_Traits?.HEALTH_BOOST")) {
                  player.addPotionEffect(new PotionEffect(PotionEffectType.HEALTH_BOOST, 
                    (int)(getConfig().getInt("Kaioken_Super_Saiyan_Blue_1_x10.Kaioken_Cooldown") * 
                    20L), 
                    0));
                }
